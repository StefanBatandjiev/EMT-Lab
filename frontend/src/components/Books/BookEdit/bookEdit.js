...
const BookEdit = (props) => {
    ...
    const [formData, updateFormData] = React.useState({
        name: "",
        category: props.book && props.book.category ? props.book.category.id : 0,
        author: props.book && props.book.author ? props.book.author.id : 0,
        availableCopies: 0
    })
        ...
        <div className="row mt-5">
            <div className="col-md-5">
                <form onSubmit={onFormSubmit}>
                    ...
                    <button id="submit" type="submit" className="btn btn-outline-primary">Submit</button>
                </form>
            </div>
        </div>
    )
